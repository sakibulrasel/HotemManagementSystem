...
import login.login;
import static room.OrderFood.USER;
...
public class ShowAvailableRoom extends javax.swing.JFrame {
    ...
    public ShowAvailableRoom(String username) {
        USER = username;
        initComponents();
        ShowAvailRooms();
    ...
    private void BookingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BookingActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                new BookRoom(RNO,USER).setVisible(true);
                this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowAvailableRoom(USER).setVisible(true);
            }
        });
    }
